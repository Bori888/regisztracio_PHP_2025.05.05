	...
	class User{
		...
		public function __construct() {	
			...
			if ($this->kapcsolat->connect_error) {
				echo("Sikertelen kapcsolódás: " .$this->kapcsolat->connect_error);
			}
			//ékezetes betűk
		...
		public function reg_felhasznalo($nev, $email, $jelszo){
			...
			{
				$sqlReg = "INSERT INTO `felhasznalo`(`jogAzon`, `nev`, `email`, `jelszo`, `bejelentkezett`) 
				VALUES ('2','$nev','$email','$titkosJelszo', 0)";
